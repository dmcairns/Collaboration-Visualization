...
drawAuthorCollaboration2 <- function(pubListLong, inSeed=1){
  ...
  #vertices <- vertices %>%
    ...
    # mutate(theColor=case_when(
    #                           #shortName=="CL;DC;JJ;KG" & (from == "CL;DC;JJ;KG")) ~ "top1",
    #                           #((shortName=="CL;DC") & (from != "CL")) ~ "top2",
    #                           ((from=="CL") & (shortName=="CL;DC")) ~ "top4",
    #                           ((from=="CL") & (shortName=="CL;OF")) ~ "top4",
    ...
    #                           ((from=="CB;TF") & (shortName=="CB;TF;WJ")) ~ "top6",
    ...
    #                           ((from=="CT") & (shortName=="CT;DG")) ~ "top4",
    #                           ((from=="CT;DG") & (shortName=="CT;DG;TR")) ~ "top6",
    #                           ((from=="BG") & (shortName=="BG;TF")) ~ "top4",
    #                           ((from=="BG") & (shortName=="BG;IG")) ~ "top4",
    #                           ((from=="BG") & (shortName=="BG;ZZ")) ~ "top4",
    #                           ((from=="BG") & (shortName=="BG;DG")) ~ "top4",
    #                           ((from=="BG") & (shortName=="BG;JS")) ~ "top4",
    #                           ((from=="BG;IG") & (shortName=="BG;IG;TF")) ~ "top6",
    #                           ((from=="BG;TF") & (shortName=="BG;TF;ZZ")) ~ "top6",
    #                           ((from=="BG;DG") & (shortName=="BG;DG;ZZ")) ~ "top6",
    #                           ((from=="LZ") & (shortName=="LZ;ZZ")) ~ "top4",
    #                           ((from=="ZC") & (shortName=="ZC;ZZ")) ~ "top4",
    #                           ((from=="JC") & (shortName=="JC;WJ")) ~ "top4",
    #                           ((from=="CL;DC") & (shortName=="CL;DC")) ~ "top5",
    #                           ((from=="CL;DC") & (shortName=="CL;DC;JJ")) ~ "top7",
    #                           ((from=="CL;OF") & (shortName=="CL;OF;SQ")) ~ "top4",
    #                           ((from=="CT;DG") & (shortName=="CT;DG;TR")) ~ "top4",
    #                           ((from=="BR") & (shortName=="BR;OF")) ~ "top4",
    #                           #((from=="BR") & (shortName=="BR;GA")) ~ "top4",
    #                           ((from=="BR;OF") & (shortName=="BR;OF;SQ")) ~ "top6",
    ...
    #                           ((from=="AK;CB") & (shortName=="AK;CB;WJ")) ~ "top6",
    ...
    #                           ((from=="CB") & (shortName=="CB;DC")) ~ "top4",
    #                           ((from=="CB;DC") & (shortName=="CB;DC;TF")) ~ "top6",
    ...
    #                           shortName=="BG;DG;ZZ" ~ "top5",
    #                           ((from=="CT;DG;TR") & (shortName=="CT;DG;TR")) ~ "top5",
    #                           TRUE ~ shortName))
  edges1 <-
  ...
  vertices <- vertices %>%
    ...
    mutate(newValue=case_when(
      ((shortName=="HC;LZ") & (level==4)) ~ 7,
      ((shortName=="HC;ZC") & (level==4)) ~ 7,
      TRUE ~ level
    ))

  assign("edgesMid", edgesMid, pos=1)
  assign("vertices", vertices, pos=1)
  mygraph <- graph_from_data_frame(edgesMid, vertices=vertices )
  ...
  outGraph <- ggraph(mygraph, layout = 'circlepack', weight=size) +
    ...
    # scale_fill_manual(values=c("top" = "tan",
    #                            "top1"="blue",
    #                            "top2"="green",
    #                            "top3"="white",
    #                            "top4"="pink",
